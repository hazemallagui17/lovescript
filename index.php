...
/*  
Dev : Hazem Allagui
URL : https://www.facebook.com/hazeminfo
...
-->
    ...
    <body>
        ...
        <div id = "main" align = "center">
            <p><a href = "./index.php"><img src = "./img/logo.png" alt = "Calculate your love!" width="414" height="91" style = "border: medium none ;" /></a>          </p>
            <h2>قيس نسبة حبك بينك و بين شريكك</h2>
            <p><br />
            </p>
<form name = "test" action = "#">
                <table border = "0">
                    <tbody>
                        <tr>
                            <td><span class="style1"><img src="./img/boy.png" width="50" height="50" /></span> 
...
<td style = "background-image: url('img/heart.png');background-repeat:no-repeat; width: 128px; height: 128px;">
                            ...
                            <td><span class="style1"><img src="./img/girl.png" width="50" height="50" /></span>
            ...
            <center>
                ...
                <p><br />
                  ...
                  <span class="style1">&copy; Calculos Love 2013 - 2017 By <a href = "http://www.hazemallagui.ga">Hazem Allagui</a></span></p>
          </center>
        </div>
